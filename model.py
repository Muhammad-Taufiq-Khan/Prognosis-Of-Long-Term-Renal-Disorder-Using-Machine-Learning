...
def CKD_Prediction(specific_gravety, albumin, blood_urea, serum_creatinine, hemoglobine, red_blood_cells, hypertension, diabetes_mellitias):
    ...
    # Xtest = Xtest.reshape((1,8))

    # # Using List
    # Xtest = [[specific_gravety, albumin, blood_urea, serum_creatinine, hemoglobine, red_blood_cells, hypertension, diabetes_mellitias]]
    
    #Previous Code
    # Xtest = Xtest[['specific_gravety', 'albumin','blood _urea', 'serum_creatinine', 'hemoglobine', 'red_blood_cells','pus_cell_clumps', 'hypertension', 'diabetes_mellitias']]
    ...
    return RFmodel.predict(Xtest)

# CKD_Prediction(specific_gravety, albumin, blood_urea, serum_creatinine, hemoglobine, red_blood_cells, hypertension, diabetes_mellitias)
# CKD_Prediction(1.005, 4.0, 11.2, 32.0, 1.0, 0.0, 1.0, 0.0)
# CKD_Prediction(NaN, 1.0, NaN, 30.0,NaN, 0, 1.0, NaN)
# CKD_Prediction(1.025, 0, 14.5, 52, NaN, 0, 0, 0)
